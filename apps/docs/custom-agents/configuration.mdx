    ...
    .langgraph.metadata({
      x_oap_ui_config: {
        ...
        options: [
          ...
          {
            label: "Ollama Turbo 20B",
            value: "ollama/gpt-oss:20b-cloud",
          },
          {
            label: "Ollama Turbo 120B",
            value: "ollama/gpt-oss:120b-cloud",
          },
          {
            label: "Ollama Turbo DeepSeek 671B",
            value: "ollama/deepseek-v3.1:671b-cloud",
          },
        ],
      },
    }),
        ...
        metadata={
            "x_oap_ui_config": {
                ...
                "options": [
                    ...
                    {"label": "Ollama Turbo 20B", "value": "ollama:gpt-oss:20b-cloud"},
                    {"label": "Ollama Turbo 120B", "value": "ollama:gpt-oss:120b-cloud"},
                    {"label": "Ollama Turbo DeepSeek 671B", "value": "ollama:deepseek-v3.1:671b-cloud"},
                ],
            }
        }
    )
